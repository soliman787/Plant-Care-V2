...
class SelectYourCropViewBody extends StatefulWidget {
  const SelectYourCropViewBody({super.key});

  @override
  State<SelectYourCropViewBody> createState() => _SelectYourCropViewBodyState();
}

class _SelectYourCropViewBodyState extends State<SelectYourCropViewBody> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, String>> crops = [
      {'name': S.of(context).potato, 'image': Assets.imagesPotatos},
          ...
          child: Align(
            ...
            child: Padding(
              ...
              child: CustomButton1(
                ...
                backgroundColor: selectedCrops.isNotEmpty  // Disable if no crop is selected
